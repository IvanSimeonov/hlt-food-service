...
public interface FoodRepository extends JpaRepository<Food, Long> {
    @Query("SELECT new com.ivnsim.hltfoodservice.domains.FoodTableViewDTO(f.id, f.brandName, f.description, f.calories) " +
            ...
            "OR UPPER(f.calories) LIKE UPPER(CONCAT('%', :searchWord, '%'))")
